...
/*
  ⚠️ На телефоне переход цвета снят.

  Он тянется 400 мс, и пока человек прокручивает, одновременно «горят» все слова,
  залитые за последние 400 мс. Браузер перерисовывает крупную антикву каждый кадр —
  это была одна из причин подёргивания в блоке «Подход». Без перехода перерисовывается
  только то слово, которое залилось прямо сейчас. На глаз разницы почти нет: слова
  и так загораются по очереди от прокрутки.
*/
