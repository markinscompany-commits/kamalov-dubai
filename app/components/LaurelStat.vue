...
.laurel {
  /*
    Насколько контент поднят от середины коробки к проёму ветви.
    Ветвь открыта сверху и сходится внизу: по центру знак садится на перекрестье
    стеблей, а «пустое место» у венка выше середины. Значение подобрано по кадру
    в увеличении, а не на глаз - см. tools/laurel-check.mjs.
  */
  --mark-lift: 26%;
